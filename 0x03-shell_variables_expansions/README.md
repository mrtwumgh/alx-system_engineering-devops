This README gives a description of all the scripts in this directory
...
3. 2-path: a script that adds /action to the PATH. /action should be the last directory the shell looks into when looking for a program.
